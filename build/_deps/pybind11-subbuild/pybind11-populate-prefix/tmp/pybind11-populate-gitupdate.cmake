...
if("${show_ref_output}" MATCHES "refs/remotes/v2.6.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.6.2")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.6.2
  WORKING_DIRECTORY "/home/fo_pluto/demo_opencv/build/_deps/pybind11-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/fo_pluto/demo_opencv/build/_deps/pybind11-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/fo_pluto/demo_opencv/build/_deps/pybind11-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
